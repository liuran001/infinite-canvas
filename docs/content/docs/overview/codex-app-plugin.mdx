...
```text
请从 https://github.com/liuran001/infinite-canvas.git 安装 Infinite Canvas Codex 插件。
...
```bash
mkdir -p ~/plugins
git clone https://github.com/liuran001/infinite-canvas.git ~/plugins/infinite-canvas
```
