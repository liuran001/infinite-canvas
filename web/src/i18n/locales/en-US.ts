export default {
    ...
    teams: {
        roles: { owner: "Owner", admin: "Administrator", member: "Member", viewer: "Read-only" },
        windows: { day: "Daily", month: "Monthly", total: "Lifetime" },
        statuses: { active: "Active", suspended: "Suspended", disabled: "Disabled by platform", disbanded: "Disbanded" },
        common: { refresh: "Refresh", loading: "Loading…", noDescription: "No description", credits: "Team credits", unlimited: "Unlimited" },
        tabs: { overview: "Overview", members: "Members", invites: "Invitations", logs: "Transactions" },
        list: {
            eyebrow: "Team collaboration",
            title: "My Teams",
            description: "Platform administrators top up team credits. Generation costs incurred within a team are charged to that team's balance.",
            create: "Create team",
            created: "Team created",
            createFailed: "Failed to create team",
            joinPrompt: "Have an invitation code? Join directly",
            inviteCodePlaceholder: "Enter invitation code",
            inviteCodeAria: "Invitation code",
            join: "Join team",
            inviteCodeRequired: "Enter an invitation code first",
            joined: "Joined team",
            joinFailed: "Failed to join team",
            loadFailed: "Failed to load teams",
            empty: "You haven't joined any teams yet",
            disabled: "This team has been disabled by a platform administrator. Only history can be viewed.",
            createBlocked: "Each user can create up to {{limit}} teams. You have already created {{owned}}. Disband a team you no longer need, or join someone else's team with an invitation code.",
            form: {
                title: "Create team",
                confirm: "Create",
                name: "Team name",
                nameRequired: "Enter a team name",
                namePlaceholder: "For example: Design",
                description: "Team description",
                optional: "Optional",
            },
        },
        layout: {
            loadFailed: "This team does not exist, or you are no longer a member",
            back: "← Back to My Teams",
            realtimeDisconnected: "Live sync disconnected. Refresh the page.",
            realtimePolling: "Live updates are unavailable. Refreshing every 30 seconds.",
            realtimeReady: "Balance is syncing live",
            realtimeConnecting: "Connecting live sync…",
            myRole: "My role: {{role}}",
            disabled: "This team has been disabled by a platform administrator and is read-only",
            navLabel: "Team navigation",
        },
        detail: {
            saved: "Saved",
            saveFailed: "Failed to save team",
            selectTransferTarget: "Select a new owner",
            transferred: "Team ownership transferred",
            transferFailed: "Failed to transfer team ownership",
            leaveTitle: "Leave this team?",
            leaveDescription: "After leaving, you can no longer use team credits to generate content. Existing transaction records will be retained.",
            leaveConfirm: "Leave",
            left: "Left team",
            leaveFailed: "Failed to leave team",
            disbandTitle: "Disband “{{name}}”?",
            disbandDescription: "All members will be removed. Team canvases will return to their respective owners' personal accounts, while transaction history is retained for reconciliation.",
            disbandConfirm: "Disband",
            disbanded: "Team disbanded",
            disbandFailed: "Failed to disband team",
            fields: { name: "Team name", description: "Team description", memberLimit: "Member limit", people: "{{count}} people", status: "Status", createdAt: "Created" },
            storageTitle: "Team cloud storage",
            storageDescription: "Images uploaded to team canvases and generated results count toward this storage. It is separate from your personal cloud storage. Only a platform administrator can adjust the quota.",
            storageNearlyFull: "Team storage is almost full. Remove canvases and assets the team no longer needs, or ask a platform administrator to raise the quota.",
            creditsDescription: "Only a platform administrator can top up team credits. Whether your personal credits are used when team credits run out is controlled by the switch in Preferences and is off by default.",
            edit: "Edit team details",
            transfer: "Transfer ownership",
            disband: "Disband team",
            leave: "Leave team",
            editTitle: "Edit team details",
            nameRequired: "Enter a team name",
            transferTitle: "Transfer ownership",
            transferConfirm: "Confirm transfer",
            transferDescription: "After the transfer, you will become an administrator. The new owner will control disbanding and future transfers.",
            transferPlaceholder: "Select a team member",
            transferAria: "Select the member who will take ownership",
        },
        members: {
            saved: "Saved",
            saveFailed: "Failed to save member settings",
            removeTitle: "Remove “{{name}}” from the team?",
            removeDescription: "They will no longer be able to use team credits. Existing transaction records will be retained.",
            removeConfirm: "Remove",
            removed: "Member removed",
            removeFailed: "Failed to remove member",
            title: "Team members",
            description: "Usage is calculated in real time for the selected period from the same transactions used for billing.",
            loadFailed: "Failed to load members",
            empty: "No other members yet. Create an invitation on the Invitations tab.",
            columns: { member: "Member", role: "Role", limit: "Limit", status: "Status", joinedAt: "Joined", actions: "Actions" },
            limitUsage: "{{used}} / {{limit}} ({{window}})",
            unlimitedUsage: "{{used}} / Unlimited",
            settings: "Settings",
            remove: "Remove",
            modalTitle: "Member settings · {{name}}",
            ownerRoleHint: "The owner role can only be changed by transferring ownership.",
            adminRoleHint: "Only the owner can appoint administrators.",
            selectRole: "Select member role",
            limitLabel: "Credit limit",
            unlimitedHint: "Enter 0 for unlimited.",
            creditsUnit: "credits",
            windowLabel: "Limit period",
            selectWindow: "Select limit period",
            statusLabel: "Member status",
            ownerStatusHint: "The owner cannot be suspended.",
            statusHint: "A suspended member cannot use team credits or access team data.",
            selectStatus: "Select member status",
        },
        invites: {
            accessDenied: "Only the team owner and administrators can manage invitations.",
            codeCreated: "Invitation code created",
            createFailed: "Failed to create invitation",
            enabled: "Enabled",
            disabled: "Disabled",
            saveFailed: "Failed to save invitation",
            deleteTitle: "Delete this invitation?",
            deleteDescription: "The link or invitation code will stop working immediately. Existing members are not affected.",
            deleteConfirm: "Delete",
            deleted: "Deleted",
            deleteFailed: "Failed to delete invitation",
            title: "Invitations",
            description: "A full invitation link is shown only when it is created; afterward, the server keeps only its hash. Invitation codes remain available to view and copy below.",
            selectRole: "Select the role granted by the invitation",
            createCode: "Create invitation code",
            createLink: "Create invitation link",
            loadFailed: "Failed to load invitations",
            empty: "No invitations yet. Create one above.",
            columns: { credential: "Type / credential", role: "Role", usedLimit: "Used / limit", status: "Status", createdAt: "Created", actions: "Actions" },
            copyCode: "Copy invitation code",
            linkSummary: "Invitation link · {{prefix}}… (full link shown once at creation)",
            toggleAria: "Enable or disable this invitation",
            exhausted: "Fully used",
            generatedTitle: "Invitation link created",
            close: "Close",
            copiedLink: "Invitation link copied",
            copyLink: "Copy link",
            onceDescription: "This is the only time the full link is shown. After closing, even the server cannot retrieve it; the list will show only the prefix.",
            linkAria: "Invitation link",
        },
        logs: {
            types: { topup: "Top-up", adminAdjust: "Administrator adjustment", aiConsume: "Generation charge", aiRefund: "Refund", insufficient: "Insufficient balance" },
            title: "Team credit transactions",
            description: "An “Insufficient balance” record does not change the balance; it explains why a generation request was rejected.",
            scopeAria: "Change transaction scope",
            all: "Entire team",
            mine: "My transactions",
            loadFailed: "Failed to load team transactions",
            empty: "No transaction records yet",
            total: "{{count}} records",
            columns: { createdAt: "Time", type: "Type", member: "Member", model: "Model", amount: "Change", balance: "Balance after change", remark: "Note" },
        },
        join: {
            joined: "Joined team",
            joinFailed: "Failed to join team",
            loginTitle: "Sign in before joining the team",
            loginDescription: "Team data is not available to signed-out visitors. This invitation will still work after you sign in.",
            login: "Sign in",
            validating: "Checking invitation…",
            invalidTitle: "Invitation link is invalid or no longer active",
            invalidDescription: "The invitation may have been disabled, fully used, or expired. Ask a team administrator for a new one.",
            myTeams: "Go to My Teams",
            invitedTo: "You have been invited to join",
            summary: "{{count}} members · Role after joining: {{role}}",
            join: "Join team",
        },
        realtime: {
            sessionExpired: "Your session has expired. Sign in again.",
            permissionChanged: "Your permissions in this team have changed. Refresh the page.",
            notMember: "You are no longer in this team, or the team has been disbanded.",
            noStream: "The team live connection returned no content",
            connectFailed: "Could not connect team live sync. Check the server and your network.",
            httpFailed: "Team live connection failed (HTTP {{status}})",
            quotaTitle: "Team cloud storage is full",
            quotaDescription:
                "The upload did not succeed. The team's cloud storage is full, not your personal storage—deleting your personal canvases will not free team space. Remove team canvases or assets that are no longer needed, or ask a platform administrator to raise this team's quota.",
            viewTeam: "Open My Teams",
            acknowledge: "Got it",
            creditsTitle: "Team credits are exhausted",
            creditsDescription: "Nothing was generated and no credits were charged. Only a platform administrator can top up team credits. You can also continue by allowing your personal credits to be used; the two balances remain separate.",
            enableFallback: "Enable personal-credit fallback",
            contactAdmin: "Open My Teams to contact an administrator",
        },
        errors: {
            list: "Failed to load teams",
            create: "Failed to create team",
            load: "Failed to load team",
            save: "Failed to save team",
            disband: "Failed to disband team",
            transfer: "Failed to transfer team ownership",
            leave: "Failed to leave team",
            members: "Failed to load members",
            saveMember: "Failed to save member settings",
            removeMember: "Failed to remove member",
            invites: "Failed to load invitations",
            createInvite: "Failed to create invitation",
            saveInvite: "Failed to save invitation",
            deleteInvite: "Failed to delete invitation",
            logs: "Failed to load team transactions",
            myLogs: "Failed to load my transactions",
            invalidInvite: "Invitation link is invalid or no longer active",
            join: "Failed to join team",
        },
    },
    config: {
