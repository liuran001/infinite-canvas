...
import { ArrowLeft, Coins, FolderOpen, Images, Settings, Sparkles, Ticket, Users, UsersRound, Wand2 } from "lucide-react";
...
const navItems = [
    ...
    { key: "/admin/invites", icon: <Ticket className="size-4" />, label: <Link to="/admin/invites">邀请码</Link> },
    { key: "/admin/teams", icon: <UsersRound className="size-4" />, label: <Link to="/admin/teams">团队管理</Link> },
